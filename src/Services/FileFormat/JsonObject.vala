...
public abstract class Spice.FileFormat.JsonObject : GLib.Object {
    ...
    private void load_key (string key, Json.Object source_object) {
        ...
        if (val.type () == prop.value_type) {
            ...
            } else if (type.is_a (typeof (Spice.FileFormat.JsonObjectArray))) {
                if (val.get_object () == null) {
...
public abstract class Spice.FileFormat.JsonObjectArray : Object {
